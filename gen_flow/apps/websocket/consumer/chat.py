...
from gen_flow.apps.session.serializers import SessionMessageReadSerializer, GenerateRequestSerializer
from gen_flow.apps.session.generator.entities import GenerateRequest
from gen_flow.apps.session.generator.chat import ChatGenerator
from gen_flow.apps.websocket.auth_middleware import WebSocketRequest
from gen_flow.apps.websocket.messages import ChatResponse, ChatResponseType
from gen_flow.apps.websocket.consumer.base import BaseConsumer
...
class ChatGenerateConsumer(BaseConsumer):
    ...
    def handle_request(self, serializer: GenerateRequestSerializer) -> SessionMessage:
        ...
        result: Result = self.generator.generate(
