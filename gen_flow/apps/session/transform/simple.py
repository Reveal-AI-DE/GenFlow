...
from gen_flow.apps.ai.llm.messages import Message, UserMessage, SystemMessage
...
class SimplePromptTransform(BasePromptTransform):
    ...
    def get_prompt(
        ...
        return self._get_chat_model_messages(
            pre_prompt=prompt_template_entity.simple_prompt_template if prompt_template_entity else None,
            files=files,
            query=query,
            context=context,
            memory=memory,
