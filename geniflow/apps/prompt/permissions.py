...
from geniflow.apps.iam.permissions import GeniFlowBasePermission
...
class PromptGroupPermission(GeniFlowBasePermission, EntityGroupPermission, LimitMixin):
    """
...
class PromptPermission(GeniFlowBasePermission, EntityBasePermission, LimitMixin):
    """
