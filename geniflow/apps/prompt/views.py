...
from geniflow.apps.core.mixin import EntityGroupViewSetMixin
from geniflow.apps.core.views import EntityBaseViewSet
from geniflow.apps.prompt import permissions as perms
from geniflow.apps.prompt.models import Prompt
from geniflow.apps.prompt.serializers import PromptReadSerializer, PromptWriteSerializer
