...
from geniflow.apps.team.models import Invitation, Team, TeamRole


class TeamPermission(GeniFlowBasePermission, LimitMixin):
    """
...
class MembershipPermission(GeniFlowBasePermission):
    """
...
class InvitationPermission(GeniFlowBasePermission, LimitMixin):
    """
