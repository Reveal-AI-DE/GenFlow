...
from geniflow.apps.ai.base.entities.model import PropertyKey
from geniflow.apps.ai.llm.entities import Result, Usage
from geniflow.apps.ai.llm.messages import AssistantMessage, Message
from geniflow.apps.core.config.llm_model_bundle import LLMModelBundle
from geniflow.apps.prompt.models import PromptType
from geniflow.apps.session.models import Session
from geniflow.apps.session.transform.base import PromptTemplateEntity
from geniflow.apps.session.transform.simple import SimplePromptTransform
...
class BaseGenerator:
    ...
    def __init__(self, db_session: Session, llm_model_bundle: LLMModelBundle) -> None:
        """
    ...
    def recalculate_max_tokens(self, input_messages: list[Message]):
        """
    ...
    def organize_input_messages(
        ...
        if (
            prompt_template_entity is None
            or prompt_template_entity.prompt_type == PromptType.SIMPLE
        ):
