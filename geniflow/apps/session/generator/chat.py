...
from geniflow.apps.ai.llm.entities import Result
from geniflow.apps.assistant.models import Assistant, AssistantContextSource
...
from geniflow.apps.core.models import Provider
from geniflow.apps.prompt.models import Prompt, PromptType
from geniflow.apps.session.generator.base import BaseGenerator
from geniflow.apps.session.generator.entities import GenerateEntity, GenerateRequest
from geniflow.apps.session.models import Session, SessionMode, SessionType
