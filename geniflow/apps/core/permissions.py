...
class ProviderPermission(GeniFlowBasePermission):
    """
...
class AIModelPermission(GeniFlowBasePermission):
    """
...
class EntityGroupPermission:
    ...
    @classmethod
    def check_base_scopes(cls, subclass: GeniFlowBasePermission, is_team_owner: bool) -> bool:
        """
    ...
    @classmethod
    def filter(cls, subclass: GeniFlowBasePermission, queryset):
        """'
        Filters the queryset based on the permissions
        """
