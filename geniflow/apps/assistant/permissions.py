...
from geniflow.apps.assistant.models import Assistant
from geniflow.apps.core.models import EntityGroup
from geniflow.apps.core.permissions import EntityBasePermission, EntityGroupPermission
from geniflow.apps.iam.permissions import GeniFlowBasePermission, StrEnum
from geniflow.apps.restriction.mixin import LimitMixin
from geniflow.apps.team.models import TeamRole


class AssistantGroupPermission(GeniFlowBasePermission, EntityGroupPermission, LimitMixin):
    """
...
class AssistantPermission(GeniFlowBasePermission, EntityBasePermission, LimitMixin):
    """
