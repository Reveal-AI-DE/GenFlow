...
"""
Django settings for geniflow project.
...
from geniflow import __version__
...
INSTALLED_APPS = [
    ...
    "geniflow.apps.team",
    "geniflow.apps.iam",
    "geniflow.apps.restriction",
    "geniflow.apps.core",
    "geniflow.apps.prompt",
    "geniflow.apps.assistant",
    "geniflow.apps.session",
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_RENDERER_CLASSES": [
        "geniflow.apps.core.renderers.GeniFlowAPIRenderer",
        "rest_framework.renderers.BrowsableAPIRenderer",
    ],
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.IsAuthenticated",
        "geniflow.apps.iam.permissions.PermissionEnforcer",
    ],
    ...
    "DEFAULT_PAGINATION_CLASS": "geniflow.apps.core.pagination.CustomPagination",
    "PAGE_SIZE": 10,
    "DEFAULT_FILTER_BACKENDS": (
        "rest_framework.filters.SearchFilter",
        "django_filters.rest_framework.DjangoFilterBackend",
        "rest_framework.filters.OrderingFilter",
        "geniflow.apps.team.filters.TeamFilterBackend",
    ),
    "SEARCH_PARAM": "search",
    ...
    "EXCEPTION_HANDLER": "geniflow.apps.core.exception_handler.custom_exception_handler",
}

REST_AUTH = {
    "REGISTER_SERIALIZER": "geniflow.apps.iam.serializers.RegisterSerializerEx",
    "PASSWORD_RESET_SERIALIZER": "geniflow.apps.iam.serializers.PasswordResetSerializerEx",
...
MIDDLEWARE = [
    ...
    "geniflow.apps.team.middleware.IAMContextMiddleware",
...
ASGI_APPLICATION = "geniflow.asgi.application"
...
ACCOUNT_ADAPTER = "geniflow.apps.iam.adapters.DefaultAccountAdapterEx"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "server_file": {
            ...
            "level": "DEBUG",
            "filename": os.path.join(BASE_DIR, "logs", "geniflow_server.log"),
            "formatter": "standard",
...
SPECTACULAR_SETTINGS = {
    "TITLE": "GeniFlow REST API",
    "DESCRIPTION": "REST API for GeniFlow project",
    ...
    "CONTACT": {
        "name": "Reveal AI team",
        "url": "https://github.com/Reveal-AI-DE/GeniFlow",
        "email": "support@revealai.de",
    },
    "LICENSE": {
        "name": "Apache 2.0 License Extended",
        "url": "https://github.com/Reveal-AI-DE/GeniFlow/blob/develop/LICENSE.md",
    },
    "SERVE_PUBLIC": True,
    ...
    "EXTERNAL_DOCS": {
        "description": "GeniFlow documentation",
        "url": "https://docs.geniflow.revealai.de/docs/",
    },
    # OTHER SETTINGS
    ...
    "ENUM_NAME_OVERRIDES": {
        "StatusEnum": "geniflow.apps.assistant.models.AssistantStatus",
    },
